...
namespace ECommerceApp.Migrations
{
    ...
    [Migration("20260420155926_Product variation and it's images")]
    partial class Productvariationanditsimages
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ECommerceApp.Models.OpeningQtyProductVariation", b =>
                {
                    b.Property<int>("OpeningQtyProductVariationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OpeningQtyProductVariationID"));

                    b.Property<int?>("OpeningQtyID")
                        .HasColumnType("int");

                    b.Property<int?>("ProductVariationDetailsID")
                        .HasColumnType("int");

                    b.HasKey("OpeningQtyProductVariationID");

                    b.HasIndex("OpeningQtyID");

                    b.HasIndex("ProductVariationDetailsID");

                    b.ToTable("tblOpeningQtyProductVariation", "Inv");
                });

            modelBuilder.Entity("ECommerceApp.Models.OpeningQuantityImage", b =>
                {
                    b.Property<int>("ProductOpeningQuantityImageID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProductOpeningQuantityImageID"));
                    ...
                    b.Property<int>("OpeningQuantityID")
                        .HasColumnType("int");

                    b.HasKey("ProductOpeningQuantityImageID");

                    b.HasIndex("FileName")
                        .IsUnique();

                    b.HasIndex("OpeningQuantityID");

                    b.ToTable("tblOpeningQuantityImage", "Inv");
                });
            ...
            modelBuilder.Entity("ECommerceApp.Models.ProductOpeningQuantity", b =>
                {
                    b.Property<int>("OpeningQuantityID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("OpeningQuantityID"));

                    b.Property<int?>("AccClassID")
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime?>("QuantityDate")
                        .HasColumnType("datetime2");

                    b.Property<decimal?>("SalesRate")
                        .HasColumnType("money");

                    b.HasKey("OpeningQuantityID");

                    b.HasIndex("ProductID");

                    b.ToTable("tblOpeningQuantity", "Inv");
                });

            modelBuilder.Entity("ECommerceApp.Models.ProductVariation", b =>
                {
                    b.Property<int>("ID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ECommerceApp.Models.ProductVariationDetails", b =>
                {
                    b.Property<int>("ProductVariationDetailsID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");

                    SqlServerPropertyBuilderExtensions.UseIdentityColumn(b.Property<int>("ProductVariationDetailsID"));
            ...
            modelBuilder.Entity("ECommerceApp.Models.OpeningQtyProductVariation", b =>
                {
                    b.HasOne("ECommerceApp.Models.ProductOpeningQuantity", "OpeningQuantity")
                        .WithMany("OpeningQtyProductVariations")
                        .HasForeignKey("OpeningQtyID");

                    b.HasOne("ECommerceApp.Models.ProductVariationDetails", "ProductVariationDetails")
                        .WithMany()
                        .HasForeignKey("ProductVariationDetailsID");

                    b.Navigation("OpeningQuantity");
            ...
            modelBuilder.Entity("ECommerceApp.Models.OpeningQuantityImage", b =>
                {
                    b.HasOne("ECommerceApp.Models.ProductOpeningQuantity", "OpeningQuantity")
                        .WithMany("Images")
                        .HasForeignKey("OpeningQuantityID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("ECommerceApp.Models.ProductVariationDetails", b =>
                {
                    b.HasOne("ECommerceApp.Models.ProductVariation", "ProductVariation")
            ...
            modelBuilder.Entity("ECommerceApp.Models.Product", b =>
                {
                    ...
                    b.Navigation("OpeningQuantities");
            ...
            modelBuilder.Entity("ECommerceApp.Models.ProductOpeningQuantity", b =>
                {
                    ...
                    b.Navigation("OpeningQtyProductVariations");
                });
